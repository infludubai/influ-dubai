...
export function pageMetadata({
  ...
  noIndex?: boolean;
  /**
   * Optional override. Leave unset so Next injects the image generated by
   * `app/opengraph-image.tsx` — setting `images` here suppresses that
   * convention, and previously pointed every preview at a non-existent
   * /og.png, so no link preview rendered anywhere.
   */
  image?: string;
}): Metadata {
