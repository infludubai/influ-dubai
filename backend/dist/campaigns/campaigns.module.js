...
exports.CampaignsModule = CampaignsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [campaigns_service_1.CampaignsService, matching_service_1.MatchingService],
        exports: [campaigns_service_1.CampaignsService, matching_service_1.MatchingService],
    })
], CampaignsModule);
