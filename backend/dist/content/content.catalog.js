...
exports.CONTENT_FIELDS = exports.CONTENT_PAGES = void 0;
exports.getField = getField;
exports.isKnownContentKey = isKnownContentKey;
...
exports.CONTENT_FIELDS = [
    ...
    },
    {
        ...
        default: 'Discover verified UAE and MENA creators, vet their audiences before you spend, and run every campaign from brief to payout in one place.',
    },
...
const BY_KEY = new Map(exports.CONTENT_FIELDS.map((f) => [f.key, f]));
...
function defaults() {
    return Object.fromEntries(exports.CONTENT_FIELDS.map((f) => [f.key, f.default]));
}
//# sourceMappingURL=content.catalog.js.map