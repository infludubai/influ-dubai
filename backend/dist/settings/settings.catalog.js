...
exports.SETTING_DEFINITIONS = exports.SETTING_GROUPS = void 0;
exports.getDefinition = getDefinition;
exports.isKnownSetting = isKnownSetting;
exports.SETTING_GROUPS = [
    {
        id: 'openai',
        title: 'OpenAI',
        description: 'Powers creator insights, campaign suggestions and AI fraud scoring. Without a key these features fall back to rule-based logic.',
    ...
    },
    {
        id: 'stripe',
        title: 'Stripe',
        description: 'Subscription billing and creator payouts. Without a key billing runs in mock mode and no real charges are made.',
    ...
    },
    {
        id: 'smtp',
        title: 'Email (SMTP)',
        description: 'Sends verification and password-reset emails. Without a host, links are written to the server log instead.',
        testable: true,
    },
    {
        id: 'platform',
...
exports.SETTING_DEFINITIONS = [
    ...
    },
    {
        ...
        isSecret: false,
        placeholder: 'on',
        help: 'Set to "off" to silence every outgoing email without losing the SMTP ' +
    ...
    },
    {
        ...
        isSecret: false,
        placeholder: 'off',
        help: 'Set to "on" and new signups cannot log in until you approve them in ' +
...
const BY_KEY = new Map(exports.SETTING_DEFINITIONS.map((d) => [d.key, d]));
